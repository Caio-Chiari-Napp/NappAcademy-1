...
class TestDepartamento:
    ...
    def test_instanciar(self):
        ...
        assert objeto.responsavel.nome is 'José da Silva'
    ...
    def test_responsavel(self):
        ...
        assert departamento.responsavel.nome is 'José da Silva'
        departamento.informar_responsavel('Silva', 1, 1, 1990)
        assert departamento.responsavel.nome == 'Silva'

    def test_responsavel_substituido(self):
        departamento = Departamento('Departamento XYZ', 'José da Silva', 1, 1, 1990)
        assert departamento.responsavel.nome is 'José da Silva'
        departamento.informar_responsavel('José Silva', 1, 1, 1990)
        assert departamento.responsavel.nome == 'José Silva'
    ...
    def test_verificar_aniversariantes(self):
        retorno = [('João Oliveira', '1992-03-28', 'Departamento XYZ'),
                   ('Luis Fernando', '2000-03-28', 'Departamento XYZ'),
                   ('José da Silva', '1990-03-28', 'Departamento XYZ')]
        dt1 = date.today() - timedelta(days=4)
        hoje = date.today()
        depto = Departamento('Departamento XYZ', 'José da Silva', 1, 1, 1990)
